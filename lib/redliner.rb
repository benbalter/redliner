...
module Redliner
  class App < Sinatra::Base
    ...
    def pull_request_body
      <<-BODY
This pull request was generated by [Redliner](https://github.com/benbalter/redliner/).

Submitted on behalf of #{user_name} from #{request.ip} using #{request.user_agent}".
      BODY
    end
